	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			category1 : {
				name : 'Otros', //Will appear in the data and in the default feedback message.
				title : {
			...
			category2 :	{
				name : 'Yo', //Will appear in the data and in the default feedback message.
				title : {
			...
			leftKeyText : 'Pulsa "E" para', 
			rightKeyText : 'Pulsa "I" para', 
